...
function Skills() {
  return (
       ...
       <p className='text-3xl text-white mb-5 text-center '>Skills</p>
       <div className="skill rounded-xl shadow-2xl shadow-neutral-700 bg-white text-black w-96 h-80 border flex flex-row justify-between px-7 py-16 pt-24 ">      
       <span className='absolute top-44 left-88 ml-10 mb-5 text-2xl text-black'>Frontend development</span> 
